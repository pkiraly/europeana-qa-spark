...
object ProxyBasedCompletenessToParquet {

  def main(args: Array[String]): Unit = {

    val log = org.apache.log4j.LogManager.getLogger("ProxyBasedCompletenessToParquet")
    val spark = SparkSession.builder.appName("ProxyBasedCompletenessToParquet").getOrCreate()
